...
public interface DownloadListener {
    ...
    void connectStart(@NonNull DownloadTask task, @IntRange(from = 0) int blockIndex, @NonNull Map<String, List<String>> requestHeaderFields);

    void connectEnd(@NonNull DownloadTask task, @IntRange(from = 0) int blockIndex, int responseCode, @NonNull Map<String, List<String>> responseHeaderFields);

    void fetchStart(@NonNull DownloadTask task, @IntRange(from = 0) int blockIndex, @IntRange(from = 0) long contentLength);

    void fetchProgress(@NonNull DownloadTask task, @IntRange(from = 0) int blockIndex, @IntRange(from = 0) long increaseBytes);

    void fetchEnd(@NonNull DownloadTask task, @IntRange(from = 0) int blockIndex, @IntRange(from = 0) long contentLength);
