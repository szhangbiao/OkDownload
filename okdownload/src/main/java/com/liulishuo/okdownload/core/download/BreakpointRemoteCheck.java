...
public class BreakpointRemoteCheck {
    ...
    public BreakpointRemoteCheck(@NonNull DownloadTask task, @NonNull BreakpointInfo info) {
        this.task = task;
        this.info = info;
    }
    ...
    public void check() throws IOException {
        ...
        final ResumeFailedCause resumeFailedCause = downloadStrategy
                .getPreconditionFailedCause(responseCode, info.getTotalOffset() != 0, info, responseEtag);
        ...
        if (!isTrialSpecialPass(responseCode, instanceLength, resumable) && downloadStrategy.isServerCanceled(responseCode, info.getTotalOffset() != 0)) {
