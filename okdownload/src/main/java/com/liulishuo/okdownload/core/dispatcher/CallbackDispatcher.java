...
public class CallbackDispatcher {
    ...
    public void endTasksWithError(@NonNull final Collection<DownloadTask> errorCollection, @NonNull final Exception realCause) {
    ...
    public void endTasks(@NonNull final Collection<DownloadTask> completedTaskCollection, @NonNull final Collection<DownloadTask> sameTaskConflictCollection, @NonNull final Collection<DownloadTask> fileBusyCollection) {
    ...
    static class DefaultTransmitListener implements DownloadListener {
        ...
        @Override
        public void connectTrialStart(@NonNull final DownloadTask task, @NonNull final Map<String, List<String>> headerFields) {
        ...
        @Override
        public void connectTrialEnd(@NonNull final DownloadTask task, final int responseCode, @NonNull final Map<String, List<String>> headerFields) {
            Util.d(TAG, "<----- finish trial task(" + task.getId() + ") code[" + responseCode + "]" + headerFields);
            if (task.isAutoCallbackToUIThread()) {
                uiHandler.post(new Runnable() {
                    @Override
                    public void run() {
        ...
        @Override
        public void downloadFromBeginning(@NonNull final DownloadTask task, @NonNull final BreakpointInfo info, @NonNull final ResumeFailedCause cause) {
        ...
        @Override
        public void downloadFromBreakpoint(@NonNull final DownloadTask task, @NonNull final BreakpointInfo info) {
        ...
        @Override
        public void connectStart(@NonNull final DownloadTask task, final int blockIndex, @NonNull final Map<String, List<String>> requestHeaderFields) {
        ...
        @Override
        public void connectEnd(@NonNull final DownloadTask task, final int blockIndex, final int responseCode, @NonNull final Map<String, List<String>> requestHeaderFields) {
        ...
        @Override
        public void fetchStart(@NonNull final DownloadTask task, final int blockIndex, final long contentLength) {
        ...
        @Override
        public void fetchProgress(@NonNull final DownloadTask task, final int blockIndex, final long increaseBytes) {
        ...
        @Override
        public void fetchEnd(@NonNull final DownloadTask task, final int blockIndex, final long contentLength) {
        ...
        @Override
        public void taskEnd(@NonNull final DownloadTask task, @NonNull final EndCause cause, @Nullable final Exception realCause) {
        ...
        void inspectDownloadFromBreakpoint(@NonNull DownloadTask task, @NonNull BreakpointInfo info) {
            final DownloadMonitor monitor = OkDownload.with().getMonitor();
            if (monitor != null) monitor.taskDownloadFromBreakpoint(task, info);
        }

        void inspectDownloadFromBeginning(@NonNull DownloadTask task, @NonNull BreakpointInfo info, @NonNull ResumeFailedCause cause) {
            final DownloadMonitor monitor = OkDownload.with().getMonitor();
        ...
        void inspectTaskEnd(final DownloadTask task, final EndCause cause, @Nullable final Exception realCause) {
            final DownloadMonitor monitor = OkDownload.with().getMonitor();
