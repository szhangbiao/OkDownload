...
public abstract class DownloadListener4 implements DownloadListener, Listener4Assist.Listener4Callback, ListenerAssist {
    ...
    @Override
    public final void downloadFromBeginning(@NonNull DownloadTask task, @NonNull BreakpointInfo info, @NonNull ResumeFailedCause cause) {
        assist.infoReady(task, info, false);
    }

    @Override
    public final void downloadFromBreakpoint(@NonNull DownloadTask task, @NonNull BreakpointInfo info) {
    ...
    @Override
    public final void fetchProgress(@NonNull DownloadTask task, int blockIndex, long increaseBytes) {
    ...
    @Override
    public final void taskEnd(@NonNull DownloadTask task, @NonNull EndCause cause, @Nullable Exception realCause) {
