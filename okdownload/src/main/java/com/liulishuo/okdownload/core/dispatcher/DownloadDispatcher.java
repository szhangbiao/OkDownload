...
public class DownloadDispatcher {
    ...
    private synchronized void filterCanceledCalls(@NonNull IdentifiedTask task, @NonNull List<DownloadCall> needCallbackCalls, @NonNull List<DownloadCall> needCancelCalls) {
    ...
    private synchronized void handleCanceledCalls(@NonNull List<DownloadCall> needCallbackCalls, @NonNull List<DownloadCall> needCancelCalls) {
    ...
    private boolean inspectForConflict(@NonNull DownloadTask task, @Nullable Collection<DownloadTask> sameTaskList, @Nullable Collection<DownloadTask> fileBusyList) {
    ...
    boolean inspectForConflict(@NonNull DownloadTask task, @NonNull Collection<DownloadCall> calls, @Nullable Collection<DownloadTask> sameTaskList, @Nullable Collection<DownloadTask> fileBusyList) {
