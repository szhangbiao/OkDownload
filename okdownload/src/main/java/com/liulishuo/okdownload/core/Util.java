...
public class Util {
    ...
    public static @NonNull DownloadStore createDefaultDatabase(Context context) {
        ...
        final String storeOnSqliteClassName = "com.liulishuo.okdownload.core.breakpoint.BreakpointStoreOnSQLite";
        try {
            final Constructor constructor = Class.forName(storeOnSqliteClassName).getDeclaredConstructor(Context.class);
    ...
    public static @NonNull DownloadConnection.Factory createDefaultConnectionFactory() {
        final String okhttpConnectionClassName = "com.liulishuo.okdownload.core.connection.DownloadOkHttp3Connection$Factory";
        try {
            final Constructor constructor = Class.forName(okhttpConnectionClassName).getDeclaredConstructor();
    ...
    public static void inspectUserHeader(@NonNull Map<String, List<String>> headerField) throws IOException {
    ...
    public static void addUserRequestHeaderField(@NonNull Map<String, List<String>> userHeaderField, @NonNull DownloadConnection connection) throws IOException {
        inspectUserHeader(userHeaderField);
        addRequestHeaderFields(userHeaderField, connection);
    }

    public static void addRequestHeaderFields(@NonNull Map<String, List<String>> headerFields, @NonNull DownloadConnection connection) {
    ...
    public static void addDefaultUserAgent(@NonNull final DownloadConnection connection) {
        final String userAgent = "OkDownload/1.0.7";
