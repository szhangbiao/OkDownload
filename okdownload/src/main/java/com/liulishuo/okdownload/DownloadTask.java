...
public class DownloadTask extends IdentifiedTask implements Comparable<DownloadTask> {
    ...
    public String toString() {
        return super.toString() + "@" + id + "@" + url + "@" + directoryFile.toString() + "/" + filenameHolder.get();
    }
    ...
    public static class TaskHideWrapper {
        ...
        public static void setBreakpointInfo(@NonNull DownloadTask task, @NonNull BreakpointInfo info) {
