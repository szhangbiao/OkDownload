...
public class DownloadContext {
    ...
    public static class Builder {
        ...
        public DownloadTask bind(@NonNull DownloadTask.Builder taskBuilder) {
            ...
            if (set.minIntervalMillisCallbackProcess != null) {
                taskBuilder.setMinIntervalMillisCallbackProcess(set.minIntervalMillisCallbackProcess);
            }
    ...
    public static class QueueSet {
        ...
        public int getReadBufferSize() {
            return readBufferSize == null ? DownloadTask.Builder.DEFAULT_READ_BUFFER_SIZE : readBufferSize;
        }
        ...
        public boolean isWifiRequired() {
            return wifiRequired == null ? DownloadTask.Builder.DEFAULT_IS_WIFI_REQUIRED : wifiRequired;
        }
        ...
        public int getFlushBufferSize() {
            return flushBufferSize == null ? DownloadTask.Builder.DEFAULT_FLUSH_BUFFER_SIZE : flushBufferSize;
        }
        ...
        public int getSyncBufferSize() {
            return syncBufferSize == null ? DownloadTask.Builder.DEFAULT_SYNC_BUFFER_SIZE : syncBufferSize;
        }
        ...
        public int getSyncBufferIntervalMillis() {
            return syncBufferIntervalMillis == null ? DownloadTask.Builder.DEFAULT_SYNC_BUFFER_INTERVAL_MILLIS : syncBufferIntervalMillis;
        }
        ...
        public boolean isAutoCallbackToUIThread() {
            return autoCallbackToUIThread == null ? DownloadTask.Builder.DEFAULT_AUTO_CALLBACK_TO_UI_THREAD : autoCallbackToUIThread;
        }
        ...
        public int getMinIntervalMillisCallbackProcess() {
            return minIntervalMillisCallbackProcess == null ? DownloadTask.Builder.DEFAULT_MIN_INTERVAL_MILLIS_CALLBACK_PROCESS : minIntervalMillisCallbackProcess;
        }
        ...
        public boolean isPassIfAlreadyCompleted() {
            return passIfAlreadyCompleted == null ? DownloadTask.Builder.DEFAULT_PASS_IF_ALREADY_COMPLETED : passIfAlreadyCompleted;
        }
    ...
    static class QueueAttachListener extends DownloadListener2 {
        ...
        QueueAttachListener(@NonNull DownloadContext context, @NonNull DownloadContextListener contextListener, int taskCount) {
