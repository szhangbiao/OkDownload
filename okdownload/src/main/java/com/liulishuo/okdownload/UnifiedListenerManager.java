...
public class UnifiedListenerManager {
    ...
    public synchronized boolean detachListener(@NonNull DownloadTask task, DownloadListener listener) {
    ...
    public synchronized void attachListener(@NonNull DownloadTask task, @NonNull DownloadListener listener) {
        final int id = task.getId();
     ...
     */
    public synchronized void attachAndEnqueueIfNotRun(@NonNull DownloadTask task, @NonNull DownloadListener listener) {
    ...
    public synchronized void enqueueTaskWithUnifiedListener(@NonNull DownloadTask task, @NonNull DownloadListener listener) {
        attachListener(task, listener);
        task.enqueue(hostListener);
    }
     ...
     */
    public synchronized void executeTaskWithUnifiedListener(@NonNull DownloadTask task, @NonNull DownloadListener listener) {
        attachListener(task, listener);
