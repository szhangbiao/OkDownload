...
public class StatusUtil {
    ...
    public static boolean isCompleted(@NonNull String url, @NonNull String parentPath, @Nullable String filename) {
        return isCompleted(createFinder(url, parentPath, filename));
    }

    @Nullable
    public static BreakpointInfo getCurrentInfo(@NonNull String url, @NonNull String parentPath, @Nullable String filename) {
    ...
    @NonNull
    static DownloadTask createFinder(@NonNull String url, @NonNull String parentPath, @Nullable String filename) {
