...
import com.yunqinglai.okdownload.util.NotificationSampleListener;
...
public class NotificationActivity extends BaseSampleActivity {
    ...
    private void initListener() {
        ...
        final PendingIntent cancelPendingIntent = PendingIntent.getBroadcast(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    static class GlobalTaskManager {
        private final UnifiedListenerManager manager;
        ...
        void enqueueTask(@NonNull DownloadTask task, @NonNull DownloadListener listener) {
