...
public class EachBlockProgressUtil {
    ...
    public static void initTitle(@NonNull BreakpointInfo info, TextView taskTitleTv, TextView block0TitleTv, TextView block1TitleTv, TextView block2TitleTv, TextView block3TitleTv) {
        // task
    ...
    @Nullable
    public static ProgressBar getProgressBar(final int blockIndex, ProgressBar block0Pb, ProgressBar block1Pb, ProgressBar block2Pb, ProgressBar block3Pb) {
        if (blockIndex == 0) {
            return block0Pb;
        } else if (blockIndex == 1) {
            return block1Pb;
    ...
    @Nullable
    public static TextView getSpeedTv(int blockIndex, final TextView block0SpeedTv, final TextView block1SpeedTv, final TextView block2SpeedTv, final TextView block3SpeedTv) {
        if (blockIndex == 0) {
    ...
    private static void assembleTitleToView(String prefix, long rangeLeft, long rangeRight, TextView titleTv) {
