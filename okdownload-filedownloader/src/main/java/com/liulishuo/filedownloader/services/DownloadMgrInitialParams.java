    ...
    public static class InitCustomMaker {
        ...
        public void commit() {
            ...
            if (mOutputStreamCreator != null) {
                ...
                builder.outputStreamFactory(new DownloadOutputStreamAdapter.Factory(mOutputStreamCreator));
            }
            if (mConnectionCreator != null) {
                if (builder == null) builder = new OkDownload.Builder(mContext);
                builder.connectionFactory(new DownloadConnectionAdapter.Factory(mConnectionCreator));
            }
