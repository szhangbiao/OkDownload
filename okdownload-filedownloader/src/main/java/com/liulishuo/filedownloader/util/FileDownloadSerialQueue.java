...
public class FileDownloadSerialQueue {
    ...
    public void enqueue(BaseDownloadTask task) {
        ...
        listenerManager.attachListener(downloadTaskAdapter.getDownloadTask(), downloadTaskAdapter.getCompatListener());
    }
    ...
    public List<BaseDownloadTask> shutdown() {
        ...
        for (DownloadTask task : tasks) {
            final DownloadTaskAdapter notRunningTask = FileDownloadUtils.findDownloadTaskAdapter(task);
